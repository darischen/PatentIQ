...
import { Settings, User, Shield, Bell, Key, CreditCard, Layout, Globe, ChevronRight, Save } from 'lucide-react';
        ...
        <div className="col-span-12 lg:col-span-3 space-y-1">
          {tabs.map((tab) => (
            <button
              ...
              className={`w-full flex items-center gap-3 px-5 py-4 rounded-2xl font-bold text-sm transition-all active:scale-95 ${
                activeTab === tab.id 
          ...
          {activeTab === 'general' && (
            <div className="space-y-10 animate-in fade-in duration-300">
               ...
               <div className="pt-6 border-t border-slate-50 flex justify-end">
                  <button className="bg-slate-900 text-white px-8 py-3.5 rounded-xl font-black text-[11px] uppercase tracking-widest flex items-center gap-2 hover:bg-slate-800 transition-all shadow-xl shadow-slate-200 active:scale-95">
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
               ...
               <div className="space-y-4">
                 ...
                 <div className="flex gap-3">
                    ...
                    />
                    <button className="px-6 py-3.5 bg-white border border-slate-200 rounded-xl text-[11px] font-black text-slate-600 uppercase tracking-widest hover:bg-slate-50 transition-all active:scale-95">
                      Update Key
                    </button>
                 </div>
               </div>
